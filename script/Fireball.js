...
class IceBall{
    constructor(x,y,direction){
        ...
        this.speedX = 0;
        this.speedY = 0;
        this.spriteUp = new Animation(this.x,this.y,"iceball_up_",4,12,50);
        this.spriteDown = new Animation(this.x,this.y,"iceball_down_",4,12,50);
        this.spriteLeft = new Animation(this.x,this.y,"iceball_left_",4,12,50);
        this.spriteRight = new Animation(this.x,this.y,"iceball_right_",4,12,50);
        this.sprite = this.spriteUp;
        switch(direction){
            case 1://up
                this.speedY = -3;
